...
setup(name='t2Mon',
      ...
      data_files=CONFIG,
      scripts=["src/executors/generalmon-local", "src/executors/samtest-local", "src/executors/namenode-mon", "src/executors/datanode-mon", "src/executors/gridftp-mon", "src/executors/xrootd-mon"]
     )
